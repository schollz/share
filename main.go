...
var serveCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		relay.Start(port, maxRooms, maxRoomsPerIP, dbURL, staticFS, logger)
	},
}
...
var sendCmd = &cobra.Command{
	...
	Long:  "Send a file, folder, or text through E2E encryption to a specified room. Folders are automatically zipped for transfer. If the argument is not a file or folder, it will be sent as text.",
